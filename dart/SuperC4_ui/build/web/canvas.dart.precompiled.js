...
function dart_precompiled($collectedClasses) {
  ...
  function CssAnimation(_rule, _keyframes, _id, _name) {
    this._rule = _rule;
  ...
  function CssAnimation__buildRule_closure(rule_0) {
    this.rule_0 = rule_0;
  }
  CssAnimation__buildRule_closure.builtin$cls = "CssAnimation__buildRule_closure";
  if (!"name" in CssAnimation__buildRule_closure)
    CssAnimation__buildRule_closure.name = "CssAnimation__buildRule_closure";
  $desc = $collectedClasses.CssAnimation__buildRule_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CssAnimation__buildRule_closure.prototype = $desc;
  function CssAnimation__buildRule__closure(rule_1) {
    this.rule_1 = rule_1;
  }
  CssAnimation__buildRule__closure.builtin$cls = "CssAnimation__buildRule__closure";
  if (!"name" in CssAnimation__buildRule__closure)
    CssAnimation__buildRule__closure.name = "CssAnimation__buildRule__closure";
  $desc = $collectedClasses.CssAnimation__buildRule__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CssAnimation__buildRule__closure.prototype = $desc;
  function CssAnimation_apply_closure(box_0, this_1, element_2, iterations_3, alternate_4, persist_5, onComplete_6) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.element_2 = element_2;
    this.iterations_3 = iterations_3;
    this.alternate_4 = alternate_4;
    this.persist_5 = persist_5;
    this.onComplete_6 = onComplete_6;
  }
  CssAnimation_apply_closure.builtin$cls = "CssAnimation_apply_closure";
  if (!"name" in CssAnimation_apply_closure)
    CssAnimation_apply_closure.name = "CssAnimation_apply_closure";
  $desc = $collectedClasses.CssAnimation_apply_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CssAnimation_apply_closure.prototype = $desc;
  function CssAnimation_apply__closure(element_7) {
    this.element_7 = element_7;
  }
  CssAnimation_apply__closure.builtin$cls = "CssAnimation_apply__closure";
  if (!"name" in CssAnimation_apply__closure)
    CssAnimation_apply__closure.name = "CssAnimation_apply__closure";
  $desc = $collectedClasses.CssAnimation_apply__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CssAnimation_apply__closure.prototype = $desc;
  ...
  function _CustomHashMap(_equals, _hashCode, _validKey, _length, _strings, _nums, _rest, _keys) {
  ...
  function PolymerElement(change_notifier$ChangeNotifier$_changes, change_notifier$ChangeNotifier$_records, polymer$Polymer$_polymer$_element, polymer$Polymer$_namedObservers, polymer$Polymer$_observers, polymer$Polymer$_unbound, polymer$Polymer$_unbindAllJob, polymer$Polymer$_propertyObserver, polymer$Polymer$_readied, polymer$Polymer$_jsElem, polymer$Polymer$_hasBeenAttached, polymer$Polymer$shadowRoots, polymer$Polymer$$, polymer$Polymer$_properties, polymer$Polymer$_polyfillScopeStyleCache) {
  ...
  function AutoBindingElement(_auto_binding$_self, observable$Observable$_observable$_changes, observable$Observable$_values, observable$Observable$_observable$_records, polymer$Polymer$_polymer$_element, polymer$Polymer$_namedObservers, polymer$Polymer$_observers, polymer$Polymer$_unbound, polymer$Polymer$_unbindAllJob, polymer$Polymer$_propertyObserver, polymer$Polymer$_readied, polymer$Polymer$_jsElem, polymer$Polymer$_hasBeenAttached, polymer$Polymer$shadowRoots, polymer$Polymer$$, polymer$Polymer$_properties, polymer$Polymer$_polyfillScopeStyleCache) {
    ...
    this.observable$Observable$_observable$_records = observable$Observable$_observable$_records;
    this.polymer$Polymer$_polymer$_element = polymer$Polymer$_polymer$_element;
    this.polymer$Polymer$_namedObservers = polymer$Polymer$_namedObservers;
    this.polymer$Polymer$_observers = polymer$Polymer$_observers;
    this.polymer$Polymer$_unbound = polymer$Polymer$_unbound;
  ...
  function TemplateElement_Polymer() {
  }
  ...
  function TemplateElement_Polymer_Observable() {
  }
  ...
  function CanvasDrawer(board, ready, idle, rawSize, cellSize, realSize, lineWidth, offset, center, mouseX, mouseY, gameSize, startSize, endSize, stopwatch, transitionDuration, canvas, onPlay, player) {
    this.board = board;
    this.ready = ready;
    this.idle = idle;
  ...
  CanvasDrawer.builtin$cls = "CanvasDrawer";
  if (!"name" in CanvasDrawer)
    CanvasDrawer.name = "CanvasDrawer";
  $desc = $collectedClasses.CanvasDrawer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasDrawer.prototype = $desc;
  CanvasDrawer.prototype.get$offset = function(receiver) {
    return this.offset;
  };
  function CanvasDrawer_closure(this_0) {
    this.this_0 = this_0;
  }
  CanvasDrawer_closure.builtin$cls = "CanvasDrawer_closure";
  if (!"name" in CanvasDrawer_closure)
    CanvasDrawer_closure.name = "CanvasDrawer_closure";
  $desc = $collectedClasses.CanvasDrawer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasDrawer_closure.prototype = $desc;
  function CanvasDrawer_closure0(this_1) {
    this.this_1 = this_1;
  }
  CanvasDrawer_closure0.builtin$cls = "CanvasDrawer_closure0";
  if (!"name" in CanvasDrawer_closure0)
    CanvasDrawer_closure0.name = "CanvasDrawer_closure0";
  $desc = $collectedClasses.CanvasDrawer_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasDrawer_closure0.prototype = $desc;
  function CanvasDrawer_closure1(this_2) {
    this.this_2 = this_2;
  }
  CanvasDrawer_closure1.builtin$cls = "CanvasDrawer_closure1";
  if (!"name" in CanvasDrawer_closure1)
    CanvasDrawer_closure1.name = "CanvasDrawer_closure1";
  $desc = $collectedClasses.CanvasDrawer_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasDrawer_closure1.prototype = $desc;
  function Game(board, gameSize, onPlay, currentPlayer) {
    this.board = board;
    this.gameSize = gameSize;
    this.onPlay = onPlay;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function GameManager(cd, game, server, fadeIn, fadeOut, id, request) {
    this.cd = cd;
    this.game = game;
    this.server = server;
    this.fadeIn = fadeIn;
